...
CAL-T01 bis CAL-T06 freigegeben. Migration `0005` ist lokal vorbereitet;
Staging, Echtdaten und produktive Umsetzung bleiben separat freizugeben.
...
| CAL-1 | Coach pflegt eigene Verfügbarkeit in einem rollierenden Drei-Monats-Fenster; intern wird geprüft und veröffentlicht | fachlich/architektonisch freigegeben; lokale Migration vorbereitet, Staging und Anwendungscode separat |
