...
Status: Produktwunsch, visueller Prototyp, CAL-D01 bis CAL-D08, ADR 0007 und
CAL-T01 bis CAL-T06 freigegeben. Migration `0005` ist auf isoliertem Staging
bewiesen; Anwendungscode, Echtdaten und produktive Umsetzung bleiben getrennt.
...
| CAL-1 | Coach pflegt eigene Verfügbarkeit in einem rollierenden Drei-Monats-Fenster; intern wird geprüft und veröffentlicht | fachlich/architektonisch freigegeben; Migration auf Staging bewiesen, Anwendungscode als naechster Slice |
