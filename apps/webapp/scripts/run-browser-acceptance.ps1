...
try {
    ...
    Write-Host "Coach with offers: synthetic.coach@example.invalid"
    Write-Host "Coach empty state:  synthetic.coach-empty@example.invalid"
    Write-Host "Calendar reviewer: synthetic.reviewer@example.invalid"
    Write-Host "Administrator:     synthetic.admin@example.invalid"
    Write-Host "Company contact:   synthetic.company-contact@example.invalid"
